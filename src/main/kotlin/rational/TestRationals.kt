...
class TestRationals {
    ...
    private fun testComparison(
        ...
        val result = when (comparison) {
            ComparisonOperation.EQUAL -> firstRational == secondRational
            ComparisonOperation.LESS -> firstRational < secondRational
            ComparisonOperation.MORE -> firstRational > secondRational
            ComparisonOperation.LESS_OR_EQUAL -> firstRational <= secondRational
            ComparisonOperation. MORE_OR_EQUAL -> firstRational >= secondRational
        }
    ...
    @Test
    fun test3Comparison0() = testComparison("1/2", ComparisonOperation.LESS, "1/3", false)

    @Test
    fun test3Comparison1() = testComparison("20325830850349869048604856908", ComparisonOperation.MORE, "-9192901948302584358938698", true)

    @Test
    fun test3Comparison2() = testComparison("-1042438361047144366998/59812037109262381713", ComparisonOperation.EQUAL, "1076615241954175969826/-61773005685895342531", true)

    @Test
    fun test3Comparison3() = testComparison("-1042438361047144366998/59812037109262381713", ComparisonOperation.MORE_OR_EQUAL, "-1076615241954175969826/61773005685895342531", true)

    @Test
    fun test3Comparison4() = testComparison("259877352047152420620/1282471666315533247320", ComparisonOperation.LESS_OR_EQUAL, "1461828422172186708965/7213993515334933226490", true)

    @Test
    fun test3Comparison5() = testComparison("259877352047152420620/1282471666315533247320", ComparisonOperation.LESS, "1461828422172186708965/7213993515334933226490", false)

    @Test
    fun test3Comparison6() = testComparison("87077/297895", ComparisonOperation.LESS, "40687/138970", true)

    @Test
    fun test3Comparison7() = testComparison("6548172/6479656", ComparisonOperation.MORE, "132455/130414", false)

    @Test
    fun test3Comparison8() = testComparison("95676047876718598058/21886075122687372173", ComparisonOperation.LESS, "719390507052102557245/53591306636978481949", true)

    @Test
    fun test3Comparison9() = testComparison("-48673102662562360478/2261578507553402607", ComparisonOperation.LESS_OR_EQUAL, "-3238921919908420813980/150495361935138744892", true)

    @Test
    fun test3Comparison10() = testComparison("17/382231", ComparisonOperation.EQUAL, "-17/382231", false)
